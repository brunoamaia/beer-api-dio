...
Testes unitários para validar um sistema de gerenciamento de estoques de cerveja com JUnit e Mockito. As funcionalidades da API serão desenvolvidas através da prática do TDD.
